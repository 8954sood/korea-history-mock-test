...
initialState.nowProblem = initialState.problems.splice(randomIndex, 1)[0];
...
export const problemSlice = createSlice({
    ...
    reducers: {
      ...
      setSuccessProblems: (state, action) => {
        state.successProblems = action.payload;
      },
      setFailedProblems: (state, action) => {
        state.failedProblems = action.payload;
      },
